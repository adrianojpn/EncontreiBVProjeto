...
package com.app.encontreibvrr.uploadImagem;
...
public class MainActivityStorage extends AppCompatActivity implements View.OnClickListener,
        EasyPermissions.PermissionCallbacks {

    private static final String TAG = "Storage#MainActivityStorageFire";
        ...
        photoRef.putFile(fileUri)
                ...
                .addOnFailureListener(this, new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception exception) {
                        ...
                        // [START_EXCLUDE]
                        hideProgressDialog();
                        Toast.makeText(MainActivityStorage.this, "Error: upload failed",
