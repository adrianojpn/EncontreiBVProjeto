...
public class Fragment_Perdidos extends Fragment {

    public Fragment_Perdidos() {}
    private String mTitle;

    public static Fragment_Perdidos getInstance(String title) {
        Fragment_Perdidos sf = new Fragment_Perdidos();
        sf.mTitle = title;
        return sf;
    }

    public static Fragment_Perdidos newInstance() {
        Fragment_Perdidos fragment = new Fragment_Perdidos();
        return fragment;
    }
    ...
    private static final String TAG = "FragmentPerdidos";
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        Query postsQuery = databaseReference.child("DocumentosPerdidos");
